...
- [ ] Fork and clone the repo. Delete your old fork from Github fi`rst if you are repeating this Unit.
...
- [ ] Render your characters to the DOM:
  ...
  1. Map over the list in state, and for each character render a Charac`ter to the page.
